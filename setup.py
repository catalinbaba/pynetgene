...
setup(
    ...
    version='1.1.0',                       # The current version of the package
    ...
    description="PyNetgene: A Python Library for Building the Genetic Algorithm"  # A short description of the package
)
